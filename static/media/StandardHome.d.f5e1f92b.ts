...
import { MealBoxStatisticsParams, StandardStatisticsModel } from '../Services/ReceiptService';
...
export interface StateProps {
    standardDataList: PageContent<StandardStatisticsModel>;
    loading: boolean;
...
export interface DispatchProps {
    fetchStandard: (values: MealBoxStatisticsParams) => void;
}
declare type HomeProps = FormComponentProps & StateProps & DispatchProps & RouteComponentProps<MatchPathParams>;
declare class StandardHome extends PureComponent<HomeProps, HomeState> {
    listColumns: ({
        title: string;
        dataIndex: string;
        key: string;
        render: (_: void, record: StandardStatisticsModel) => JSX.Element;
    } | {
        title: string;
        dataIndex: string;
        key: string;
...
declare const _default: import("antd/lib/form/interface").ConnectedComponentClass<import("react-redux").ConnectedComponentClass<typeof StandardHome, Pick<HomeProps, "form" | "match" | "location" | "history" | "staticContext" | "wrappedComponentRef">>, Pick<FormComponentProps<any>, "wrappedComponentRef">>;
