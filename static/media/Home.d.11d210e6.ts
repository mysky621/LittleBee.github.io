...
import { ModuleMealUnitUserState } from '../../Models/UnitUser';
...
interface StateParams {
    loading: Loading;
    Module_Meal_Unit_User: ModuleMealUnitUserState;
}
export declare const mapStateToProps: ({ loading, Module_Meal_Unit_User }: StateParams) => StateProps;
