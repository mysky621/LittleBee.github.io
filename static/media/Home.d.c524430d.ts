...
import { ModuleschoolUnitUserState } from '../../Models/UnitUser';
...
interface StateParams {
    loading: Loading;
    Module_School_Unit_User: ModuleschoolUnitUserState;
}
export declare const mapStateToProps: ({ loading, Module_School_Unit_User }: StateParams) => StateProps;
